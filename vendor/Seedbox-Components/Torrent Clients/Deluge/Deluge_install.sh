...
function Deluge_install {
    ...
    if [[ $distro_codename = buster ]]; then
        ...
        wget ./vendor/Seedbox-Components/Torrent%20Clients/Deluge/libtorrent/buster_libtorrent-rasterbar_$libtorrent_Ver-amd64.deb
...
EOF
        ...
        wget ./vendor/Seedbox-Components/Torrent%20Clients/Deluge/boost/boost-1-69-0_20220512-1_amd64.deb
        dpkg -i boost-1-69-0_20220512-1_amd64.deb
        wget ./vendor/Seedbox-Components/Torrent%20Clients/Deluge/libtorrent/bullseye_libtorrent-rasterbar_$libtorrent_Ver-amd64.deb
        dpkg -r libtorrent-rasterbar
...
EOF
    ...
    wget ./vendor/Seedbox-Components/Torrent%20Clients/Deluge/deluge.Userpass.py
    wget ./vendor/Seedbox-Components/Torrent%20Clients/Deluge/deluge.addHost.py
